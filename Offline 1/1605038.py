...
# input text or image/pdf
inputType = input("Enter type 1) Image/PDF 2) Text : ")
...
if inputType == "2":
    ...
    with open(file_path, "rb") as file_to_upload:
        # reads the image/pdf and encodes it
        byte_data = base64.b64encode(file_to_upload.read())
